...
helpSpeech = "You have asked for help. If have found the command you are looking for, say stop. If you want the text to speech to go faster, simply say faster. If you want it to go slower, say slower. If you want to move onto the next question, say next. if you want to repeat the question, say repeat."
            ...
            if (event.results[i].isFinal) {
                ...
                for(let i =0; i <validInstructions.length; ++i){
                    if(final_transcript.includes(validInstructions[i])){
                        ...
                        }else if(validInstructions[i] == 'next' || validInstructions[i] == 'start'){
                            createNextQuestion()
                        }else if(validInstructions[i] == 'repeat'){
                            speak(document.querySelector("#question").innerHTML)
                        }else if(validInstructions[i] == 'help'){
                            speak(helpSpeech)
                        }else if (validInstructions[i] == 'stop'){
